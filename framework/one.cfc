...
*/
    ...
    public struct function processRoutes( string path, array routes, string httpMethod = CGI.REQUEST_METHOD ) {
    ...
    private void function setupRequestDefaults() {
        if ( not structKeyExists(request._fw1, "requestDefaultsInitialized") or !request._fw1.requestDefaultsInitialized ) {
